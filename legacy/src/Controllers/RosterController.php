...
final class RosterController
{
    ...
    public function store(Request $request): Response
    {
        ...
        $exists = Database::fetchOne(
            'SELECT id FROM touchbase_roster WHERE team_id = ? AND user_id = ?',
            [$teamId, $userId]
        );
        ...
        Database::execute(
            'INSERT INTO touchbase_roster (team_id, user_id, number, position, notes)
             VALUES (?, ?, ?, ?, ?)',
    ...
    public function update(Request $request, array $params): Response
    {
        ...
        Database::execute(
            'UPDATE touchbase_roster SET number = ?, position = ?, notes = ? WHERE id = ?',
    ...
    public function destroy(Request $request, array $params): Response
    {
        ...
        Database::execute('DELETE FROM touchbase_roster WHERE id = ?', [$id]);
