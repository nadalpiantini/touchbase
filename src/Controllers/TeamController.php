...
final class TeamController
{
    ...
    public function index(Request $request): Response
    {
        ...
        $sql = 'SELECT t.*, c.name AS club_name, s.name AS season_name
                ...
                JOIN touchbase_clubs c ON c.id = t.club_id
    ...
    public function store(Request $request): Response
    {
        ...
        Database::execute(
            'INSERT INTO touchbase_teams (club_id, season_id, name, category)
             VALUES (?, ?, ?, ?)',
    ...
    public function update(Request $request, array $params): Response
    {
        ...
        Database::execute(
            'UPDATE touchbase_teams SET name = ?, category = ? WHERE id = ?',
            [$name, $category, $id]
        );
    ...
    public function destroy(Request $request, array $params): Response
    {
        ...
        $affected = Database::execute('DELETE FROM touchbase_teams WHERE id = ?', [$id]);
