...
echo -e "   • Shell:        ${GREEN}docker exec -it pelota_php bash${NC}"
echo ""
echo -e "${BLUE}📖 Next Steps:${NC}"
echo -e "   1. Complete Chamilo installation at http://localhost"
echo -e "   2. Test API: ${GREEN}curl http://localhost/pelota/api/teams${NC}"
echo -e "   3. View widgets: ${GREEN}http://localhost/pelota/widgets/schedule?team_id=1${NC}"
echo ""
