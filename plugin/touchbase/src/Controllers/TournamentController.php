...
final class TournamentController
{
    ...
    public function index(Request $request): Response
    {
        ...
        $sql = 'SELECT t.*, s.name AS season_name,
                ...
                FROM pelota_tournaments t
                JOIN pelota_seasons s ON s.id = t.season_id
                LEFT JOIN pelota_tournament_teams tt ON tt.tournament_id = t.id
                LEFT JOIN pelota_matches m ON m.tournament_id = t.id';
    ...
    public function show(Request $request, array $params): Response
    {
        ...
        $teams = Database::fetchAll(
            'SELECT tt.*, t.name AS team_name, t.category
             FROM pelota_tournament_teams tt
             JOIN pelota_teams t ON t.id = tt.team_id
        ...
        $matches = Database::fetchAll(
            'SELECT m.*,
             ...
             JOIN pelota_teams th ON th.id = m.team_home
             JOIN pelota_teams ta ON ta.id = m.team_away
    ...
    public function store(Request $request): Response
    {
        ...
        Database::execute(
            'INSERT INTO pelota_tournaments (season_id, name, format, start_date, end_date, status)
             VALUES (?, ?, ?, ?, ?, ?)',
    ...
    public function update(Request $request, array $params): Response
    {
        ...
        Database::execute(
            'UPDATE pelota_tournaments SET name = ?, status = ? WHERE id = ?',
            [$name, $status, $id]
        );
    ...
    public function destroy(Request $request, array $params): Response
    {
        ...
        Database::execute('DELETE FROM pelota_tournaments WHERE id = ?', [$id]);
    ...
    public function addTeam(Request $request, array $params): Response
    {
        ...
        Database::execute(
            'INSERT INTO pelota_tournament_teams (tournament_id, team_id, seed, group_name)
             VALUES (?, ?, ?, ?)',
