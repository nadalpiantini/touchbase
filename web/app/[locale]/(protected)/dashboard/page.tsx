...
export default async function DashboardPage({
  ...
  if (!profile?.default_org_id && !isDevBypass) {
    return (
      <main className="min-h-screen bg-tb-bone">
        <div className="max-w-4xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
          <div className="bg-white overflow-hidden shadow-dugout rounded-2xl border border-tb-line">
            <div className="px-4 py-5 sm:p-6">
              <h1 className="text-2xl font-display font-bold text-tb-navy mb-4">
                {t('onboarding.title')}
              </h1>
              <p className="text-sm font-sans text-tb-shadow mb-6">
    ...
    <main className="min-h-screen bg-tb-bone">
      <div className="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
        <div className="px-4 py-6 sm:px-0">
          {/* Header */}
          <div className="bg-white overflow-hidden shadow-dugout rounded-2xl mb-6 border border-tb-line">
            <div className="px-4 py-5 sm:p-6">
              <h1 className="text-3xl font-display font-bold text-tb-navy">
                {t('header.title', { orgName: org?.name || "TouchBase" })}
              </h1>
              <p className="mt-1 text-sm font-sans text-tb-shadow">
          ...
          <div className="fourths-stats-grid">
              ...
              <div className="p-5">
                <div className="flex items-center">
                  <div className="flex-shrink-0">
                    <div className="rounded-xl bg-tb-navy p-3">
                  ...
                  <div className="ml-5 w-0 flex-1">
                    <dl>
                      <dt className="text-sm font-sans font-medium text-tb-shadow truncate">
                        {t('stats.players')}
                      </dt>
                      <dd className="text-lg font-display font-semibold text-tb-navy">
                        0
                      </dd>
                    </dl>
                  </div>
            ...
            <div className="bg-white overflow-hidden shadow-dugout rounded-2xl border border-tb-line">
              <div className="p-5">
                <div className="flex items-center">
                  <div className="flex-shrink-0">
                    <div className="rounded-xl bg-tb-stitch p-3">
                      <svg className="h-6 w-6 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div className="bg-white overflow-hidden shadow-dugout rounded-2xl border border-tb-line">
              <div className="p-5">
                <div className="flex items-center">
                  <div className="flex-shrink-0">
                    <div className="rounded-xl bg-tb-red p-3">
                      <svg className="h-6 w-6 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div className="bg-white overflow-hidden shadow-dugout rounded-2xl border border-tb-line">
              <div className="p-5">
                <div className="flex items-center">
                  <div className="flex-shrink-0">
                    <div className="rounded-xl bg-tb-shadow p-3">
                      <svg className="h-6 w-6 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          {/* Quick Actions */}
          <div className="mt-8">
            <h2 className="text-lg font-display font-semibold text-tb-navy mb-4">
              {t('quickActions.title')}
            </h2>
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
              <button className="relative rounded-2xl border border-tb-line bg-white px-6 py-5 shadow-sm flex items-center space-x-3 hover:border-tb-red hover:shadow-dugout focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-tb-stitch/60 transition-all">
                <div className="flex-1 min-w-0">
                  <span className="absolute inset-0" aria-hidden="true" />
                  <p className="text-sm font-semibold text-tb-navy">
