-- ═══════════════════════════════════════════════════════════════
-- TouchBase - Deployment SQL Script
-- ═══════════════════════════════════════════════════════════════
--
-- INSTRUCTIONS:
--
-- 1. SELECT ALL (Cmd+A o Ctrl+A)
-- 2. COPY (Cmd+C o Ctrl+C)
-- 3. Open: https://supabase.com/dashboard/project/nqzhxukuvmdlpewqytpv/sql
-- 4. Click "New query"
-- 5. PASTE all this SQL
-- 6. Click "RUN" button (green button)
-- 7. Wait ~30 seconds
...
-- Optional: Clean existing tables first (uncomment if needed)
/*
