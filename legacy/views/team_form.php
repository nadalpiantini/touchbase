...
document.getElementById('team-form').addEventListener('submit', async (e) => {
    ...
    const clubId = parseInt(document.getElementById('club_id').value);
    const seasonId = parseInt(document.getElementById('season_id').value);
    
    if (isNaN(clubId) || isNaN(seasonId)) {
        alert('Please enter valid Club ID and Season ID');
        return;
    }
